...
public class hotel_reservation_system {
    ...
    private static final String password = "aditya@2003#03";
    ...
    private static void viewReservations(Connection connection) throws SQLException {
        String sql = "SELECT id, guest_name, room_no, contact_no, reseravtion_date FROM reservation";
        ...
        try (Statement statement = connection.createStatement();
            ...
            while (resultSet.next()) {
                ...
                String reservationDate = resultSet.getTimestamp("reseravtion_date").toString();
